...
const dataSharingEmbeddedSigning = exports
    ...
    , pdf1File = 'R.7_Data_Sharing_Confidentiality_Agreement.pdf'
...
function makeEnvelope(args){
    ...
    let organization = docusign.Text.constructFromObject({
        ...
        xPosition: "185", yPosition: "348",
        font: "helvetica", fontSize: "size14", tabLabel: "Company",
        height: "23", width: "84", required: "true",
        bold: 'true', value: orgName,
        locked: 'false', tabId: 'name'});

    let fullName = docusign.Text.constructFromObject({
        documentId: "3", pageNumber: "1",
        xPosition: "206", yPosition: "381",
        font: "helvetica", fontSize: "size14", tabLabel: "Name",
        height: "23", width: "84", required: "true",
    ...
    let dateTab = docusign.Text.constructFromObject({
        documentId: "3", pageNumber: "1",
        xPosition: "383", yPosition: "703",
        font: "helvetica", fontSize: "size14", tabLabel: "Date",
        height: "23", width: "84", required: "true",
        bold: 'true', value: date,
        locked: 'true', tabId: 'date'});
    
    signer1.tabs = docusign.Tabs.constructFromObject({signHereTabs: [signHere], textTabs: [organization, fullName, dateTab]});
